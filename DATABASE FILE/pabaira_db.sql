...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2022 at 08:16 PM
...
(4, 'adminsarahnie', 'adminsarahnie', 'admin', '', ''),
(5, 'adminprincess', 'adminprincess', 'adminprincess', 'Active', ''),
(6, 'adminloren', 'adminloren', 'adminloren', 'Active', ''),
(7, 'adminlyka', 'adminlyka', 'adminlyka', 'Active', '');
...
(7, 'ONLINE', 8, 0, 11, '2022-01-10', '11:00:00', 10, 'Pending', 'want to have braces'),
(8, '', 9, 0, 10, '2022-01-12', '13:30:00', 9, 'Approved', 'doc magpapacleaning po ako'),
(10, '', 11, 0, 11, '2022-01-15', '16:10:00', 10, 'Approved', 'ortho');
...
(6, 7, 6, '2021-12-14', '07:27:39', 500.00, 0.00, 'new year sale hahaha\r\n , ', '05:53:40', '2022-01-07'),
(7, 10, 9, '2022-01-14', '22:16:26', 0.00, 0.00, '', '00:00:00', '0000-00-00'),
(8, 9, 8, '2022-01-14', '22:17:57', 0.00, 0.00, '', '00:00:00', '0000-00-00');
...
(12, 6, 9, 'Consultancy Charge', 50.00, '2021-12-28', 'Active'),
(13, 6, 36, 'Treatment', 2000.00, '2021-12-28', 'Active'),
(14, 4, 4, 'Prescription Charge', 3.00, '2022-01-13', 'Active'),
(15, 8, 9, 'Consultancy Charge', 50.00, '2022-01-16', 'Active'),
(16, 8, 60, 'Treatment', 200000.00, '2022-01-16', 'Active');
...
(10, 'General Dentistry', 'A general dentist is your primary care dental provider. This dentist diagnoses, treats, and manages your overall oral health care needs, including gum care, root canals, fillings, crowns, veneers, bridges, and preventive education.', 'Active'),
(11, 'Orthodontics', ' A dentistry specialty that addresses the diagnosis, prevention, and correction of mal-positioned teeth and jaws, and misaligned bite patterns. It may also address the modification of facial growth, known as dentofacial orthopedics.Abnormal alignment of the teeth and jaws is very common.', 'Active');
...
(9, 'Jennalyn Pabaira', '09309582987', 10, 'Docjennalyn', 'docjennalyn', 'Active', 'DMD', 8.0, 50.00),
(10, 'December Joy Pabaira', '09292172690', 11, 'Docdecemberjoy', 'docdecemberjoy', 'Active', 'DMD', 8.0, 100.00),
(11, 'Doclyka', '09309582101', 10, 'doclyka', 'doclykaa', 'Active', 'MD', 7.0, 0.00);
...
(15, 'Mefinamic', 15.00, 'a nonsteroidal anti-inflammatory drug (NSAID). Mefenamic acid works by reducing hormones that cause inflammation and pain in the body.', 'Active'),
(16, 'Motrin', 35.00, 'used to treat fever, swelling, pain, and redness by preventing the body from making a substance that causes inflammation. It is a type of nonsteroidal anti-inflammatory drug (NSAID).', 'Active'),
(17, 'Tootache analgesic', 197.00, 'help with pain by reducing inflammation at the site where it is occurring.', 'Active');
...
(8, 'Sarahnie Solis', '2022-01-09', '15:54:45', 'malasiqui', '0930958567', 'san carlos city', '', 'sarahniesolis', 'sarahnie', '', 'Female', '2000-01-15', 'Active'),
(9, 'Princess Mamaril', '2022-01-09', '16:36:47', 'Magtaking SCCP', '09309585341', 'san carlos city', '', 'princess', 'princess', '', 'Female', '1999-07-21', 'Active'),
(10, 'Loren Fae De Vera', '2022-01-09', '16:40:02', 'Tebag SCCP', '0930958567', 'san carlos city', '', 'lorenfaedevera27', 'lorenfae', '', 'Female', '2000-02-27', 'Active'),
(11, 'Lyka Mae De Vera', '2022-01-12', '06:37:28', 'Tebag SCCP', '0930958567', 'san carlos city', '2420', 'lykadevera', 'lykadevera', 'A+', 'FEMALE', '2000-02-27', 'Active');
...
(4, 7, 6, '2022-01-07', '05:54:24', 1652.50, 'Active', '', 0, 0, '0000-00-00');
...
(58, 'Filings', '2000.00', 'Filings treatment', 'Active'),
(59, 'Cosmetic direct', '3000.00', 'Cosmetic direct treatment', 'Active'),
(60, 'Composite veneers', '200000.00', 'Composite veneers', 'Active'),
(61, 'Full Dentures ', '19000.00', 'Full Dentures treatment ', 'Active'),
(62, 'Partial Dentures', '12000.00', 'Partial Dentures treatment', 'Active'),
(63, 'Fixedbridge', '23000.00', 'Fixedbridge treatment', 'Active'),
(64, 'Jacket', '14000.00', 'Fixedbridge treatment', 'Active'),
(65, 'Extraction', '2000.00', 'Extraction treatment', 'Active'),
(66, 'Minor Surgery impacted wi', '150000.00', 'Minor Surgery impacted wisdom tooth treatment', 'Active'),
(67, 'Orthodontic', '30000.00', 'Orthodontic treatment', 'Active'),
(68, 'Cleaning', '9000.00', 'Cleaning treatment', 'Active');
...
(5, 36, 6, 7, 9, 'successful', '1892563715admin.jpg', '2021-12-28', '10:11:00', 'Active'),
(6, 60, 8, 9, 9, 'malasiqui', '2137928465student.jpg', '2022-01-16', '02:03:00', 'Active');
...
--
ALTER TABLE `billing`
  MODIFY `billingid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `department`
  MODIFY `departmentid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `medicine`
  MODIFY `medicineid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `treatment`
  MODIFY `treatmentid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `treatment_records`
--
ALTER TABLE `treatment_records`
  MODIFY `treatment_records_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
